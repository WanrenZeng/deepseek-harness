...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('provider-auth-unsupported'), message: z.string(), details: z.object({ provider: z.string().optional(), method: z.literal('oauth').optional() }) }),
  z.object({ code: z.literal('provider-auth-login-unknown'), message: z.string(), details: z.object({ provider: z.string().optional(), loginId: z.string().optional() }) }),
  z.object({ code: z.literal('provider-auth-prompt-unknown'), message: z.string(), details: z.object({ provider: z.string().optional(), loginId: z.string().optional(), promptId: z.string().optional() }) }),
  z.object({ code: z.literal('provider-auth-cancelled'), message: z.string(), details: z.object({ provider: z.string().optional(), loginId: z.string().optional() }) }),
  z.object({ code: z.literal('provider-auth-expired'), message: z.string(), details: z.object({ provider: z.string().optional(), loginId: z.string().optional() }) }),
  z.object({ code: z.literal('provider-auth-provider-failed'), message: z.string(), details: z.object({
    provider: z.string().optional(),
    method: z.literal('oauth').optional(),
