...
import {
  ...
  llmProviderAuthLoginAnswerValueSchema, llmProviderAuthLoginCancelValueSchema,
  llmProviderAuthLoginGetValueSchema, llmProviderAuthLoginStartValueSchema,
  llmProviderAuthLogoutValueSchema, llmProviderAuthStatusValueSchema, llmProvidersValueSchema,
...
export interface IApiClient {
  ...
  llm: {
    ...
    providerAuthStatus(payload: RequestPayload<'llm.providerAuthStatus'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'llm.providerAuthStatus'>>>
    providerAuthLoginStart(payload: RequestPayload<'llm.providerAuthLoginStart'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'llm.providerAuthLoginStart'>>>
    providerAuthLoginGet(payload: RequestPayload<'llm.providerAuthLoginGet'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'llm.providerAuthLoginGet'>>>
    providerAuthLoginAnswer(payload: RequestPayload<'llm.providerAuthLoginAnswer'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'llm.providerAuthLoginAnswer'>>>
    providerAuthLoginCancel(payload: RequestPayload<'llm.providerAuthLoginCancel'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'llm.providerAuthLoginCancel'>>>
    providerAuthLogout(payload: RequestPayload<'llm.providerAuthLogout'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'llm.providerAuthLogout'>>>
  }
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'llm.providerAuthStatus': llmProviderAuthStatusValueSchema,
  'llm.providerAuthLoginStart': llmProviderAuthLoginStartValueSchema,
  'llm.providerAuthLoginGet': llmProviderAuthLoginGetValueSchema,
  'llm.providerAuthLoginAnswer': llmProviderAuthLoginAnswerValueSchema,
  'llm.providerAuthLoginCancel': llmProviderAuthLoginCancelValueSchema,
  'llm.providerAuthLogout': llmProviderAuthLogoutValueSchema,
}
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly llm: IApiClient['llm'] = {
    ...
    providerAuthStatus: (payload, signal) => this.callUnary('llm.providerAuthStatus', payload, signal),
    providerAuthLoginStart: (payload, signal) => this.callUnary('llm.providerAuthLoginStart', payload, signal),
    providerAuthLoginGet: (payload, signal) => this.callUnary('llm.providerAuthLoginGet', payload, signal),
    providerAuthLoginAnswer: (payload, signal) => this.callUnary('llm.providerAuthLoginAnswer', payload, signal),
    providerAuthLoginCancel: (payload, signal) => this.callUnary('llm.providerAuthLoginCancel', payload, signal),
    providerAuthLogout: (payload, signal) => this.callUnary('llm.providerAuthLogout', payload, signal),
  }
